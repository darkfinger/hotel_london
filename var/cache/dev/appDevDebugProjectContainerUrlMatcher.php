...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/clients')) {
            ...
            // modify_client
            if (0 === strpos($pathinfo, '/clients/modify') && preg_match('#^/clients/modify/(?P<id_client>[^/]++)$#s', $pathinfo, $matches)) {
            ...
            // new_clients
            if (rtrim($pathinfo, '/') === '/clients/new') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'new_clients');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\ClientsController::showNew',  '_route' => 'new_clients',);
            }
